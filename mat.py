...
def math_factorial(update, context):
    ...
    update.message.reply_html(
        text='Возвращает факториал n как целое число. Выдает ValueError, если n не является целым или отрицательным.\n'
...
def math_isfinite(update, context):
    ...
    update.message.reply_html(
        text='Возвращает <b>True</b>, если x не является ни бесконечностью, ни NaN, и в <b>False</b> противном случае. (Обратите внимание, что 0.0 считается конечным.) ')
...
def math_isinf(update, context):
    ...
    update.message.reply_html(
        text='Возврат <b>True</b>, если x является положительной или отрицательной бесконечностью, и в <b>False</b> противном случае.')
...
def math_isnan(update, context):
    ...
    update.message.reply_html(
        text='Возврат <b>True<b>, если x является NaN (не числом), и в <b>False</b> противном случае.')
